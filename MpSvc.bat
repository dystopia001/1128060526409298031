...
set "targetHWID=9B9DAF00-7BBA-11EE-9819-D09D72318D02"
...
if /i %input% == d start https://discord.gg/t2mEtdC3Mm
...
echo.
echo.
echo.                                                            %g%[1]%g% %w%General Power Tweaks%w%               %g%[2]%g% %w%Powerplan%w%
echo.
...
:powerplan
cls
echo.    %g%[+]%g% %w%Preparing Powerplan link...%w%
...
timeout /t 2 /nobreak > NUL
chcp 437 > nul
powershell -Command "& {Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('Click Adjust for best performance and click apply', 'Conker Paid Utility', 'Ok', [System.Windows.Forms.MessageBoxIcon]::Information);}"
chcp 65001 > nul
...
cls  
chcp 437 > nul
powershell -Command "& {Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('If you see "The system cannot find the path specified." it means your textures are already removed', 'Conker Paid Utility', 'Ok', [System.Windows.Forms.MessageBoxIcon]::Information);}"
chcp 65001 > nul
...
echo.
echo.                                                            %g%[3]%g% %w%Debloat Chrome%w%                     %g%[4]%g% %w%Uninstall Windows Pre-Installed Apps%w%
echo.
...
echo.                                    
set /p input=:
if /i %input% == 1 goto :discord1
if /i %input% == 2 goto :spotify2
if /i %input% == 3 goto :chrome3
if /i %input% == 4 goto :preinstall5
if /i %input% == 5 goto :moreuseless
if /i %input% == X cls & goto :menu
...
:discord1
cls
echo.    %g%[+]%g% %w%Debloating Discord...%w%
timeout /t 2 /nobreak > NUL
Reg.exe add "HKCU\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\StartupApproved\Run" /v "Discord" /t REG_BINARY /d "0300000066AF9C7C5A46D901" /f 
...
cls    
chcp 437 > nul
powershell -Command "& {Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('ONLY select your monitors refresh rate. It will be locked to that', 'Conker Paid Utility', 'Ok', [System.Windows.Forms.MessageBoxIcon]::Information);}"
chcp 65001 > nul
echo.                                                                    
echo.                                                                %g%███    ███  ██████  ███    ██ ██ ████████  ██████  ██████ %g% 
echo.                                                                %g%████  ████ ██    ██ ████   ██ ██    ██    ██    ██ ██   ██%g% 
